...
public class Gateway extends TypeKeyedBase<Gateway> {
	...
	public JsonObject write() {
		...
		obj.add("failures", GSON.toJsonTree(failures));
	...
	public void write(FriendlyByteBuf buf) {
		...
		if(failures != null)
		{
			...
			failures.forEach(f -> f.write(buf));
		}
